                    ...
                    $tableBusstopOutput .= '<div class="tab-content" id="pills-tabContent">';
                      ...
                      $tableBusstopOutput .= '<div class="tab-pane fade" id="pills-disabled" role="tabpanel" aria-labelledby="pills-disabled-tab" tabindex="0">';
                        ...
                        $tableBusstopOutput .= '<div class="mb-3">';
                          $tableBusstopOutput .= '<label class="form-label" for="inputNewWorkOrderNotification'.$rowBusStop['busStopID'].'"><strong>Categorie</strong></label>';                        
                          $tableBusstopOutput .= '<select id="inputNewWorkOrderNotification'.$rowBusStop['busStopID'].'" class="form-select">';
                            $tableBusstopOutput .= '<option selected>Kies categorie</option>';
                            $tableBusstopOutput .= '<option>Haltebord</option>';
                            $tableBusstopOutput .= '<option>Haltevertrekstaat</option>';
                            $tableBusstopOutput .= '<option>Haltepaal</option>';
                            $tableBusstopOutput .= '<option>Abriposter</option>';
                          $tableBusstopOutput .= '<select>';
                          $tableBusstopOutput .= '</div>';
                        $tableBusstopOutput .= '<div class="mb-3">';
                          ...
                          $tableBusstopOutput .= '<textarea class="form-control" name="inputNewWorkOrderNotification" id="inputNewWorkOrderNotification'.$rowBusStop['busStopID'].'" cols="30" rows="8"></textarea>';
                        $tableBusstopOutput .= '</div>';
                      $tableBusstopOutput .= '</div>';
                    $tableBusstopOutput .= '</div>';
