      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card h-100">
            <div class="card-body">
              <h1 class="fs-3 fw-bolder">Totaal</h1>
              <div class="d-flex justify-content-between">
                <div class="me-3">
                  <img src="images/Flag_of_the_Netherlands.svg.png" class="img-fluid" width="100" alt="">
                  <div class="fs-2 fw-bold">49</div>
                </div>
        ...
        <div class="col-md-3">
          <div class="card h-100">
            <div class="card-body">
              <h1 class="fs-3 fw-bolder">Drenthe</h1>
              <div class="d-flex justify-content-between">
                <div class="me-3">
                  <img src="images/Flag_of_Drenthe.svg.png" class="img-fluid" width="100" alt="">
                  <div class="fs-2 fw-bold">49</div>
                </div>
                <i class="bi bi-signpost-2 fs-1"></i>
              </div>
        ...
        <div class="col-md-3">
          <div class="card h-100">
            <div class="card-body">
            <h1 class="fs-3 fw-bolder">Friesland</h1>
              <div class="d-flex justify-content-between">
                <div class="me-3">
                  <img src="images/Frisian_flag.svg.png" class="img-fluid" width="100" alt="">
                  <div class="fs-2 fw-bold">49</div>
                </div>
                <i class="bi bi-signpost-2 fs-1"></i>
              </div>
        ...
        <div class="col-md-3">
          <div class="card h-100">
            <div class="card-body">
            <h1 class="fs-3 fw-bolder">Groningen</h1>
              <div class="d-flex justify-content-between">
                <div class="me-3">
                  <img src="images/750px-Flag_Groningen.svg.png" class="img-fluid" width="100" alt="">
                  <div class="fs-2 fw-bold">49</div>
                </div>
                <i class="bi bi-signpost-2 fs-1"></i>
              </div>
