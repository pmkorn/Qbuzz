...
if ($result = mysqli_query($conn, $sql)) {
  while ($row = mysqli_fetch_array($result)) {
      ...
      $obstructionStartDate = $row['obstructionStartDate'];
      $obstructionStartTime = $row['obstructionStartTime'];
      $obstructionEndDate = $row['obstructionEndDate'];
      $obstructionEndTime = $row['obstructionEndTime'];
...
$pdf->Cell(2, 10, ':', 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(48, 10, $obstructionLines, 0, 1, 'L');
...
$pdf->Cell(2, 10, ':', 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(48, 10, date("d-m-Y", strtotime($obstructionStartDate))." om: ".date("H:i", strtotime($obstructionStartTime)), 0, 1, 'L');
...
$pdf->Cell(2, 10, ':', 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(48, 10, date("d-m-Y", strtotime($obstructionEndDate))." om: ".date("H:i", strtotime($obstructionEndTime)), 0, 1, 'L');
